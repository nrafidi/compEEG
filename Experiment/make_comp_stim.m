% Makes stimulus set for the competition phase of the competition
% experiment
% Currently makes 4 blocks with 48 pairs in each block, a mix of C/NC
% stimuli. Can easily be changed
...
% Port numbers: first half competitive, second half not competitive
