...
for s = 1:length(subjects)
    ...
    save(['/Users/nrafidi/Documents/MATLAB/compEEG-data/results/' sub '/CompEEG_CV_Slide_Accs_ItemAvg.mat'],...
        'subAcc');
    fprintf('Subject %s succeeded.\n', sub);
    toc
end

save('/Users/nrafidi/Documents/MATLAB/compEEG-data/results/CompEEG_CV_Slide_Accs_ItemAvg.mat',...
        'subAccs', 'winTime');