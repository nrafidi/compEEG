...
featureSetTimeInds = {32:40, 35:40, 47:54, 47:54, 32:40, 32:40};
featureSetRInds = {1:4, 1:4, 4, 3:4, 3:4, 1:4};

for featureSet = 2%:-1:2
    ...
    if doAUC
        ...
        save(['../../compEEG-data/results/KR_analysis_output_' featureSetNames{featureSet} '_meanTime_Direct_Base.mat'], ...
            'ROC_X_true', 'ROC_Y_true', 'ROC_T_true', 'AUCs_true', ...
            'ROC_X_pop', 'ROC_Y_pop', 'ROC_T_pop', 'AUCs_pop', 'draws_pop');
    else
        ...
        save(['../../compEEG-data/results/KR_analysis_output_pairedT_' featureSetNames{featureSet} '_meanTime_Base.mat'], ...
