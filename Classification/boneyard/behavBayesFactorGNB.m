...
save(sprintf('/Users/nrafidi/Documents/MATLAB/compEEG-data-rep/results/BayesFactor_GNB_%dfold_behav.mat', numFolds), ...
            'foldAccs', 'foldBayes');
...
set(gcf, 'Color', 'w');
set(gca, 'fontsize', 16);
export_fig(f, sprintf('../../compEEG-data-rep/results/figures/BayesFactor_GNB_%dfold_behav.pdf', numFolds));
