...
[ROC_X_true, ROC_Y_true, ROC_T_true, AUCs_true] = run_KR(cell2mat(krTrajList), cell2mat(krLabelList), ...
...
for iDraw = 1:numDraws
    ...
    [ROC_X_pop{iDraw}, ROC_Y_pop{iDraw}, ROC_T_pop{iDraw}, AUCs_pop{iDraw}] = run_KR(cell2mat(krTrajList(subjectsToUse)), ...
