...
export_fig(f1, sprintf('%s/results/figures/KR_TGM_%s_v_PVal_pooled%s_v2.png', dataRootR, computationToPlot, krWinString));
export_fig(f1, sprintf('%s/results/figures/KR_TGM_%s_v_PVal_pooled%s_v2.fig', dataRootR, computationToPlot, krWinString));
export_fig(f1, sprintf('%s/results/figures/KR_TGM_%s_v_PVal_pooled%s_v2.pdf', dataRootR, computationToPlot, krWinString));
